...
@section('container')
                ...
                <div class="card-body">
                    ...
                    <div class="custom-tab-1">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link tab-terjual" data-toggle="tab" href="#terjual"><i
    ...
    <div class="modal fade" data-backdrop="static" data-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true" id="modal-perbaikan-motor">
                                    ...
                                    <div class="basic-form">
                                        ...
                                        <div class="form-row mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control input-default money"
                                                    name="harga_beli" id="harga_beli" readonly
                                                    style="background-color: rgba(215, 218, 227, 0.3)">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-append input-primary">
                                                    <span class="input-group-text"><i
                                                            class="la la-screwdriver"></i></span>
                                                </div>
                                                <input type="text" class="form-control input-default"
                                                    placeholder="Masukan Jenis Maintenance" id="jenis_perbaikan"
                                                    name="jenis_perbaikan">
                                            </div>
                                        </div>
                                        <div class="form-row mb-3">
                                            <label class="text-label" for="tanggal_perbaikan">Tanggal Maintenance</label>
                                            <div class="input-group">
                                                <div class="input-group-append input-primary">
                                                    <span class="input-group-text"><i
                                                ...
                                                <input type="text" class="form-control input-default"
                                                    placeholder="Masukan Tanggal Penjualan" name="tanggal_perbaikan"
                                        ...
                                        <div class="form-row mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control input-default money"
                                                    placeholder="Masukan Biaya" name="biaya" id="biaya">
