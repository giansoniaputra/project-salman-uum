...
@section('container')
    ...
    {{-- Modal --}}
    <div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="modal-perbaikan-motor">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Detail Motor</h5>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="basic-form">
                                    <form>
                                        <label class="text-label" for="jenis_maintenance">Jenis Maintenance</label>
                                        <div class="form-row">
