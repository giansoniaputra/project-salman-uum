                                    ...
                                    <div class="row form-material">
                                        <div class="col-lg-6 mb-5">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control @error('no_telepon')is-invalid @enderror" name="no_telepon" id="no_telepon" value="{{ old("no_telepon") }}">
                                                @error("no_telepon")
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="daya" id="daya" class="form-control @error('daya')is-invalid @enderror" value="{{ old("daya") }}" placeholder="Masukan Daya">
                                            @error("daya")
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="bahan_bakar" id="bahan_bakar" class="form-control @error('bahan_bakar')is-invalid @enderror" value="{{ old("bahan_bakar") }}" placeholder="Masukan Bahan Bakar">
                                            @error("bahan_bakar")
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control @error('berlaku_sampai')is-invalid @enderror" value="{{ old("berlaku_sampai") }}" placeholder="Masukan Masa Berlaku" name="berlaku_sampai" id="berlaku_sampai">
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        ...
                                        <div class="form-row">
                                            <div class="input-group mb-3 col-sm-12">
                                                ...
                                                <input type="text" class="form-control @error('harga_beli')is-invalid @enderror" value="{{ old("harga_beli") }}" placeholder="Masukan Harga Beli" name="harga_beli" id="harga_beli">
                                                @error("harga_beli")
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        ...
                                        <div class="form-row">
                                            <div class="input-group mb-3 col-sm-12">
                                                ...
                                                <input type="text" class="form-control @error('tanggal_beli')is-invalid @enderror" value="{{ old("tanggal_beli") }}" placeholder="Masukan Tanggal Pembelian" name="tanggal_beli" id="tanggal_beli">
                                                @error("tanggal_beli")
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
