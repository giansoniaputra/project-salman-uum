                            ...
                            <div id="data_konsumen" class="tab-pane" role="tabpanel">
                                ...
                                <div class="col-lg-12 mb-5">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('alamat') is-invalid @enderror" rows="4"
                                ...
                                <div class="row">
                                    ...
                                    <div id="data_motor" class="tab-pane" role="tabpanel">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 mb-2">
                                                <div class="form-group">
                                                    <label class="text-label" for="tahun_pembuatan">Tahun
                                                        Pembuatan</label>
                                                    <input type="year" name="tahun_pembuatan" id="tahun_pembuatan"
                                                        class="form-control @error('tahun_pembuatan') is-invalid @enderror"
                                                        value="{{ old('tahun_pembuatan') }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-file">
                                                        <input type="file"
                                                            ...
                                                            value="{{ old('photo_stnk') }}"
                                                            name="photo_stnk" id="photo_stnk"
                                                            onchange="previewImageSTNK()">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-file">
                                                        <input type="file"
                                                            ...
                                                            value="{{ old('photo_bpkb') }}"
                                                            name="photo_bpkb" name="photo_bpkb" id="photo_bpkb"
                                                            onchange="previewImageBPKB()">
                                                        <label class="custom-file-label">Choose file</label>
                                                        @error('photo_bpkb')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
