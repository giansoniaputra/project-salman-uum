                                    ...
                                    <div class="row form-material">
                                        <div class="col-lg-6 mb-5">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control input-default @error('no_telepon')is-invalid @enderror" name="no_telepon" id="no_telepon" value="{{ old('no_telepon') }}">
                                                @error('no_telepon')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-lg-6 mb-5">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control input-default @error('alamat')is-invalid @enderror" rows="2" name="alamat" id="alamat">{{ old('alamat') }}</textarea>
                                                @error('alamat')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input-default @error('berlaku_sampai')is-invalid @enderror" value="{{ old('berlaku_sampai') }}" placeholder="Masukan Masa Berlaku" name="berlaku_sampai" id="berlaku_sampai">
                            ...
                            <div id="harga" class="tab-pane" role="tabpanel">
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        ...
                                        <div class="form-row">
                                            <div class="input-group mb-3 col-sm-12">
                                                ...
                                                <input type="text" class="form-control input-default @error('harga_beli')is-invalid @enderror" value="{{ old('harga_beli') }}" placeholder="Masukan Harga Beli" name="harga_beli" id="harga_beli">
                                                @error('harga_beli')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        ...
                                        <div class="form-row">
                                            <div class="input-group mb-3 col-sm-12">
                                                ...
                                                <input type="text" class="form-control input-default @error('tanggal_beli')is-invalid @enderror" value="{{ old('tanggal_beli') }}" placeholder="Masukan Tanggal Pembelian" name="tanggal_beli" id="tanggal_beli">
                                                @error('tanggal_beli')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col d-flex justify-content-end">
                                        <button type="submit" class="btn btn-rounded btn-primary"><span class="btn-icon-left text-primary"><i class="fa fa-plus color-primary"></i>
