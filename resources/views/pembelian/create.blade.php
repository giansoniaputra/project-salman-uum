                                    ...
                                    <div class="col-lg-6 mb-2">
                                        ...
                                        <div class="form-row">
                                            <div class="input-group mb-3 col-sm-12">
                                                ...
                                                <input type="text" class="form-control input-default money @error('harga_beli')is-invalid @enderror" value="{{ old('harga_beli') }}" placeholder="Masukan Harga Beli" name="harga_beli" id="harga_beli">
                                                @error('harga_beli')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
