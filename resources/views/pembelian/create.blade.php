                                    ...
                                    <div class="row form-material">
                                        ...
                                        <div class="col-lg-3 mb-2">
                                            ...
                                            <div class="form-group">
                                                ...
                                                value="{{ old('no_telepon') }}" placeholder="Masukan No Telepon">
                                            @error('no_telepon')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-lg-12 mb-5">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control @error('alamat') is-invalid @enderror" rows="4" name="alamat" id="alamat">{{ old('alamat') }}</textarea>
                                                @error('alamat')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
