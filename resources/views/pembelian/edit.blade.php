                    ...
                    <div class="card-body sh-35">
                        ...
                        <div class="tab-pane fade" id="data_motor" role="tabpanel">
                            ...
                            <div class="row">
                                ...
                                <div class="form-floating mb-3 col-md-6">
                                    <input type="text" name="no_polisi" id="no_polisi_input" class="form-control @error('no_polisi')is-invalid @enderror" value="{{ old('no_polisi', $motor->no_polisi) }}" placeholder="Masukan No Polisi">
                                    @error('no_polisi')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
