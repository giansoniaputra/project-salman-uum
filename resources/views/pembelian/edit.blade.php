                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="daya" id="daya" class="form-control input-default @error('daya')is-invalid @enderror" value="{{ old('daya', $motor->daya) }}" placeholder="Masukan Daya">
                                            @error('daya')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="bahan_bakar" id="bahan_bakar" class="form-control input-default @error('bahan_bakar')is-invalid @enderror" value="{{ old('bahan_bakar', $motor->bahan_bakar) }}" placeholder="Masukan Bahan Bakar">
                                            @error('bahan_bakar')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
