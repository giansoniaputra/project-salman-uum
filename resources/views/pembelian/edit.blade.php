    ...
    <div class="col-xl-12 col-xxl-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Edit Form Pembelian</h4>
            </div>
            <div class="card-body">
                <!-- Basic Start -->
                            ...
                            <div class="tab-pane fade" id="data_konsumen" role="tabpanel">
                                ...
                                <form action="/pembelian/{{ $beli->unique }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        {{-- <div class="form-floating mb-3 col-md-6">
                                            <input type="text" name="no_telepon" id="no_telepon" class="form-control @error('no_telepon')is-invalid @enderror" value="{{ old('no_telepon', $consumer->no_telepon) }}" placeholder="Masukan Nama No Telepon Dealer">
                                        @error('no_telepon')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
