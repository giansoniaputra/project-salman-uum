                                        ...
                                        <div class="col-lg-6 mb-2" style="padding-bottom:300px">
                                            <div class="form-group">
                                                ...
                                                <div class="custom-file">
                                                    ...
                                                    @enderror
                                                    <img src="/storage/{{ $motor->photo_stnk }}" style="width: 250px"
                                                        alt="" class="img-thumbnail mt-3 ml-5 image-stnk">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 mb-2" style="padding-bottom:300px">
                                            <div class="form-group">
                                                ...
                                                <div class="custom-file">
                                                    ...
                                                    @enderror
                                                    <img src="/storage/{{ $motor->photo_bpkb }}" style="width: 250px"
                                                        alt="" class="img-thumbnail mt-3 ml-5 image-bpkb">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-6 mb-2">
                                            ...
                                            <div class="form-row">
                                                <div class="input-group mb-3 col-sm-12">
                                                    ...
                                                    <input type="text"
                                                        class="form-control money input-default @error('harga_beli')is-invalid @enderror"
