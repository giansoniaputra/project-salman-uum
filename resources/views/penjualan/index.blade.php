...
<div class="row">
    <div class="col-12">
        <button type="button" class="btn btn-rounded btn-primary mb-3" data-toggle="modal" data-target=".bd-example-modal-lg"><span class="btn-icon-left text-primary"><i class="fa fa-plus color-primary"></i>
            </span>Tambah Data Penjualan</button>
        <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true" id="modal-transaksi">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                                ...
                                <div class="col-lg-12 mb-3">
                                    ...
                                    <div class="form-row">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="harga_beli" id="harga_beli" style="background-color: rgba(215, 218, 227, 0.3)" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12 mb-3">
                                    ...
                                    <div class="form-row">
                                        <div class="input-group mb-3 col-sm-12">
                                            ...
                                            <input type="text" class="form-control" placeholder="Masukan Tanggal Penjualan" name="tanggal_jual" id="tanggal_jual">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12 mb-3">
                                ...
                                <div class="col-lg-12 mb-3">
                                    ...
                                    <div class="form-row">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Masukan Harga Jual" name="harga_jual" id="harga_jual">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12 mb-3">
                                ...
                                <div class="col-lg-12 mb-3">
                                    ...
                                    <div class="form-row">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="kembali" id="kembali" readonly style="background-color: rgba(215, 218, 227, 0.3)">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-rounded btn-primary" id="save-data"><span class="btn-icon-left text-primary"><i class="fa fa-plus color-primary"></i>
                            </span>Tambah</button>
                    </div>
                </div>
            </div>
