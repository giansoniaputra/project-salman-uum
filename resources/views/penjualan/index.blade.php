                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                            ...
                            <form action="javascript:;" enctype="multipart/form-data" id="form-penjualan">
                                ...
                                <div class="row form-material">
                                    <div class="col-lg-12 mb-3" id="no-polisi">
                                        <div class="form-row">
                                            <label class="text-label" for="no_polisi">No Polisi</label><span
                                ...
                                <div class="col-lg-12 mb-3">
                                    ...
                                    <div class="col-lg-12 mb-3">
                                        <label class="text-label" for="alamat">Alamat</label><span
                                            class="text-danger">*</span>
                                        <div class="form-row">
                                            <div class="input-group">
                        ...
                        <div class="col-lg-12 mb-3">
                            ...
                            <div class="col-lg-12 mb-3">
                                <label class="text-label" for="jenis_pembayaran">Jenis Pembayaran</label><span
                                    class="text-danger">*</span>
                                <div class="form-row">
                                    <div class="input-group">
                                        <div class="input-group-append input-primary">
                        ...
                        <div id="buys-content-cash" class="row form-material d-none" style="padding-bottom: 92.75px">
                            <div class="col-lg-12 mb-3">
                                <label class="text-label" for="harga_jual">Harga Jual</label><span
                                    class="text-danger">*</span>
                                <div class="form-row">
                                    <div class="input-group">
                                        <div class="input-group-append input-primary">
                            ...
                            <div class="col-lg-12 mb-3">
                                <label class="text-label" for="jumlah_bayar">Jumlah Bayar</label><span
                                    class="text-danger">*</span>
                                <div class="form-row">
                                    <div class="input-group">
                                        <div class="input-group-append input-primary">
                                        ...
                                        <input type="text" class="form-control input-default money"
                                            placeholder="Masukan Jumlah Bayar" name="jumlah_bayar" id="jumlah_bayar">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 mb-3">
                                ...
                                <div class="form-row">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control input-default money" name="kembali"
                                            id="kembali" readonly style="background-color: rgba(215, 218, 227, 0.3)">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div id="buys-content-kredit" class="row form-material d-none" style="padding-bottom: 92.75px">
                            <div class="col-lg-12 mb-3">
                                <label class="text-label" for="tempat_lahir">Tempat Lahir</label><span
                                    class="text-danger">*</span>
                                <div class="form-row">
                                    <div class="input-group">
                                        <input type="text" class="form-control input-default"
                                            placeholder="Masukan Tempat Lahir" name="tempat_lahir" id="tempat_lahir">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 mb-3">
                                <label class="text-label" for="tanggal_lahir">Tanggal Lahir</label><span
                                    class="text-danger">*</span>
                                <div class="form-row">
                                    <div class="input-group">
                                        <div class="input-group-append input-primary">
                                        ...
                                        <input type="text" class="form-control input-default"
                                            placeholder="Masukan Tanggal Lahir" name="tanggal_lahir" id="tanggal_lahir">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 mb-3">
                                <label class="text-label" for="jenis_kelamin">Jenis Kelamin</label><span
                                    class="text-danger">*</span>
                                <div class="form-row">
                                    <div class="input-group">
                            ...
                            <div class="col-lg-12 mb-3">
                                ...
                                <div class="form-row">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control input-default money" name="dp_bayar"
                                            id="dp_bayar" placeholder="Masukan DP Bayar" readonly style="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 mb-3">
                                ...
                                <div class="form-row">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control input-default money" name="pencairan"
                                            id="pencairan" placeholder="Masukan Pencairan" readonly style="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 mb-3">
                                ...
                                <div class="form-row">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control input-default money" name="angsuran"
                                            id="angsuran" placeholder="Masukan Angsuran" readonly style="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 mb-3">
                                ...
                                <div class="form-row">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control input-default money" name="tenor"
                                            id="tenor" placeholder="Masukan Tenor" readonly style="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 mb-3">
                                ...
                                <div class="form-row">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control input-default money" name="komisi"
                                            id="komisi" placeholder="Masukan Komisi" readonly style="">
                                    </div>
                                </div>
                            </div>
                        </div>
