                    ...
                    <div class="modal-content">
                        ...
                        <form action="javascript:;">
                                ...
                                <div class="basic-form">
                                    ...
                                    <div class="form-row">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input-default money" name="modal"
                                                id="modal" placeholder="" value="{{ $data->modal }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-rounded btn-primary" id="save-data-modal"><span
