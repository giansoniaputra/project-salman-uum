                ...
                <div class="row">
                    <div class="col-xl-3 col-sm-6">
                        <div class="card bg-primary">
                            <div class="card-body">
                                <div class="media align-items-center">
                                    <div class="media-body mr-3">
                                        <h2 class="fs-20 font-w600 text-white" id="refresh-modal">{{ rupiah($data->modal) }}</h2>
                            ...
                            <div class="progress  rounded-0" style="height:4px;">
                                <div class="progress-bar rounded-0 bg-red progress-animated" style="width: 50%; height:4px;" role="progressbar">
                    ...
                    <div class="col-xl-3  col-sm-6">
                        <div class="card bg-primary">
                            <div class="card-body">
                                <div class="media align-items-center">
                                    <div class="media-body mr-3">
                                        <h2 class="fs-20 text-white font-w600" id="refresh-asset">{{ rupiah($bike_sele) }}</h2>
                    ...
                    <div class="col-xl-3  col-sm-6">
                        <div class="card bg-primary">
                            ...
                            <div class="progress  rounded-0" style="height:4px;">
                                <div class="progress-bar rounded-0 bg-red progress-animated" style="width: 30%; height:4px;" role="progressbar">
                    ...
                    <div class="col-xl-3  col-sm-6">
                        <div class="card bg-primary">
                            <div class="card-body">
                                <div class="media align-items-center">
                                    <div class="media-body mr-3">
                                        <h2 class="fs-20 text-white font-w600" id="refresh-laba">{{ rupiah($laba) }}</h2>
                            ...
                            <div class="progress  rounded-0" style="height:4px;">
                                <div class="progress-bar rounded-0 bg-red progress-animated" style="width: 94%; height:4px;" role="progressbar">
