    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <label class="text-label" for="laporan_pertahun">Laporan Pembelian Pertahun</label>
                    ...
                    <div class="col-12 mt-5">
                        <form action="/pembelianDate" method="post">
                            ...
                            <div class="input-daterange input-group">
                                <input type="date" class="date form-control" name="tanggal_awal" placeholder="Tanggal Awal" />
                                <span class="mx-2"></span>
                                <input type="date" class="date form-control" name="tanggal_akhir" placeholder="Tanggal Akhir" />
                                <span class="mx-2"></span>
