...
@section('container')
    ...
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    <div class="custom-tab-1">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link tab-comsumer" data-toggle="tab" href="#data_dealer"><i
        ...
        <!-- Modal -->
        <div class="modal fade" id="modal-motor" data-backdrop="static" data-keyboard="false" tabindex="-1"
